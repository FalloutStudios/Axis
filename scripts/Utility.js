...
module.exports = class AxisUtility {
    ...
    async loadModules(directory) {
        ...
        await registerInteractionCommmands(this.Client, this.commands.InteractionCommands, this.config.guildId, this.config.permissions.interactionCommands.ignoreDeployTxt);
